package beakjun.n11004kthElement;
...
public class Main2 {
	...
	private static int pickCleverPivot(int left, int right, int[] array) {
		...
		for (int i = left; i <= right; i += 5) {
			...
			if ((tempRight - i) <= 2) {
				...
				medianSubgroup = getMedianValue(i, tempRight, array); // Retrieve
																		// median
																		// of
																		// subarray
			}
	...
	/*
	 * main() Contains code to test the LinearSelect. Nothing in this function
